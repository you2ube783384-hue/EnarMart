        ...
        <div className="max-w-4xl mx-auto px-4 lg:px-8">
          <div className="space-y-10 text-[#666666] leading-relaxed">
            ...
            <div>
              ...
              <p>
                All templates on EnarMart are sold under a <strong className="text-[#333333]">Standard License</strong> unless otherwise specified. Some premium templates may include an <strong className="text-[#333333]">Extended License</strong> option for broader commercial use.
              </p>
            </div>
            ...
            <div>
              ...
              <h3
                className="text-lg font-semibold text-[#333333] mb-3"
                style={{ fontFamily: "var(--font-poppins)" }}
              >
                What You CAN Do:
              </h3>
              <ul className="list-disc pl-6 mb-6 space-y-2">
                <li>Use the template for <strong className="text-[#333333]">personal projects</strong> such as personal branding, resumes, and social media accounts</li>
                <li>Use the template for <strong className="text-[#333333]">commercial projects</strong> for one business or client, including social media posts, presentations, and marketing materials</li>
            ...
            <div>
              ...
              <ul className="list-disc pl-6 mb-6 space-y-2">
                <li>Use the template for <strong className="text-[#333333]">unlimited client projects</strong> — no per-client restrictions</li>
                <li>Create <strong className="text-[#333333]">Print-on-Demand (POD)</strong> products using the customized design (t-shirts, mugs, posters, etc.)</li>
                <li>Use in <strong className="text-[#333333]">digital products for sale</strong>, such as eBooks, online courses, or digital downloads, provided the template is significantly modified and not distributed as an editable Canva file</li>
                <li>Use the template across <strong className="text-[#333333]">multiple businesses or brands</strong> owned by the licensee</li>
              </ul>
              <p className="mb-3">
            ...
            <div>
              ...
              <ul className="list-disc pl-6 space-y-3">
                <li>
                  <strong className="text-[#333333]">Canva Account Required:</strong> You must have a Canva account (free or Pro) to access and edit the template. Some templates may require Canva Pro for full access to premium elements, fonts, and features.
                </li>
                <li>
                  <strong className="text-[#333333]">Template Link:</strong> Upon purchase, you will receive a Canva template link. This link is for your use only and should not be shared, distributed, or made publicly accessible.
                </li>
                <li>
                  <strong className="text-[#333333]">Canva Pro Elements:</strong> Templates containing Canva Pro elements will display watermarks or require a Pro subscription to use without watermarks. This is clearly indicated on each product listing.
                </li>
                <li>
                  <strong className="text-[#333333]">Platform Changes:</strong> Canva may update its platform, features, or element library, which could affect template appearance or functionality. We are not responsible for changes made by Canva that impact template performance.
                </li>
                <li>
                  <strong className="text-[#333333]">Third-Party Assets:</strong> Some templates may include placeholder images, fonts, or graphics that are subject to Canva&apos;s own licensing terms. Please review Canva&apos;s content license agreement for details on third-party assets.
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <div className="mt-4 p-6 bg-[#f8f5f2] rounded-lg">
                <p className="text-[#333333] font-semibold mb-2">EnarMart Licensing Team</p>
