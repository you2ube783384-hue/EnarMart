        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-10">
          <div className="space-y-10 text-[#555770] leading-relaxed">
            ...
            <div>
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li><strong className="text-[#1a1a2e]">Order Processing:</strong> To process and fulfill your digital template purchases, deliver download links, and provide order confirmations</li>
                <li><strong className="text-[#1a1a2e]">Account Management:</strong> To create and manage your EnarMart account, including your purchase history and template library</li>
                <li><strong className="text-[#1a1a2e]">Communication:</strong> To send transactional emails (order receipts, download links), respond to support inquiries, and deliver newsletter content you have opted into</li>
                <li><strong className="text-[#1a1a2e]">Site Improvement:</strong> To analyze usage patterns, improve our template offerings, enhance user experience, and optimize site performance</li>
                <li><strong className="text-[#1a1a2e]">Marketing:</strong> To send promotional content about new templates, special offers, and seasonal discounts (only with your consent)</li>
                <li><strong className="text-[#1a1a2e]">Security:</strong> To detect and prevent fraud, unauthorized access, and other illegal activities</li>
                <li><strong className="text-[#1a1a2e]">Legal Compliance:</strong> To comply with applicable laws, regulations, and legal processes</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li><strong className="text-[#1a1a2e]">Service Providers:</strong> With trusted third-party vendors who assist in operating our Site (e.g., payment processors like Stripe, email delivery services, and cloud hosting providers)</li>
                <li><strong className="text-[#1a1a2e]">Legal Requirements:</strong> When required by law, court order, or governmental regulation</li>
                <li><strong className="text-[#1a1a2e]">Business Transfers:</strong> In connection with a merger, acquisition, or sale of all or a portion of our assets</li>
                <li><strong className="text-[#1a1a2e]">Consent:</strong> With your explicit consent for any purpose not described in this policy</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li><strong className="text-[#1a1a2e]">Access:</strong> Request a copy of the personal data we hold about you</li>
                <li><strong className="text-[#1a1a2e]">Correction:</strong> Request correction of inaccurate or incomplete personal data</li>
                <li><strong className="text-[#1a1a2e]">Deletion:</strong> Request deletion of your personal data, subject to legal obligations</li>
                <li><strong className="text-[#1a1a2e]">Opt-Out:</strong> Unsubscribe from marketing communications at any time via the link in our emails</li>
                <li><strong className="text-[#1a1a2e]">Cookie Management:</strong> Manage cookie preferences through your browser settings</li>
                <li><strong className="text-[#1a1a2e]">Data Portability:</strong> Request your data in a structured, commonly used format</li>
              </ul>
              <p className="mt-3">
            ...
            <div>
              ...
              <div className="mt-4 p-6 bg-[#f5f5f7] rounded-xl">
                <p className="text-[#1a1a2e] font-semibold mb-2">EnarMart Privacy Team</p>
